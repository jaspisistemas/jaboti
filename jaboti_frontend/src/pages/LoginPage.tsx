...
import { Box, Typography, TextField, Button, Card, CardContent, Avatar, Fade } from '@mui/material';
        ...
        <Card sx={{ maxWidth: 400, width: '100%', mx: 'auto', boxShadow: 6, borderRadius: 4, p: { xs: 2, sm: 3 } }}>
          <CardContent>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mt: 1.5 }}>
              Agora o login é por usuário e senha (não mais email). Base URL atual: {import.meta.env.VITE_API_BASE_URL}
            </Typography>
          </CardContent>
        </Card>
      </Fade>
